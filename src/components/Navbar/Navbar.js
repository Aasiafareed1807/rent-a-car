     ...
     <div className="flex justify-between items-center">
       ...
       <div className= "hidden md:block">
        <ul className="flex items-center gap-8">
            ...
            <li key={data.id}
            className= "py-4">
                <a className="py-2 hover:border-b-2 hover:text-yellow-400 hover:border-yellow-400 transition-colors duration-500 text-lg font-medium" href={data.link}>{data.name}</a>
            </li>
            ))}
            {/*Dark Mode Icons*/}
           <div>
